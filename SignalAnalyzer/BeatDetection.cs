...
namespace SignalAnalyzer
{
    public class BeatDetection
    {
        ...
        {
            //立ち上がり成分抽出
            double[] sumD = ExtractRisingComponent(freqAnalyzer.stftData, 0,10000, 44100);
        ...
        {
            var peekTime = SavitzkyGolayFilter(data, 17);
       ...
       */
        ...
        public int CalcBeatInterval(double[] data)
        {
            ...
            //妥当な時間内になるようにマージ
            while (beatInterval < 32) beatInterval += beatInterval;
